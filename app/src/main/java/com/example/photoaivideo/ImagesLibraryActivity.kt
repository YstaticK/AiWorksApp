...
class ImagesLibraryActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Always ensure misc. Images exists
        ensureDefaultFolder("PicturesLibrary/misc. Images")

        // Show dialog immediately to create new image folders
        showCreateFolderDialog("PicturesLibrary", "Image")
    }
